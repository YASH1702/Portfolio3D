  ...
  const actions: ActionItem[] = useMemo(
    () => [
      ...
      },
      {
        ...
        category: "Projects",
        title: "CareerPulse",
        sub: "Career Application Copilot & Extension",
        action: () => router.push("/projects/careerpulse"),
      },
      {
        id: "proj-coredesk",
        category: "Projects",
        title: "CoreDesk",
        sub: "Business Operations & Subscription Platform",
        action: () => router.push("/projects/coredesk"),
      },
      {
        id: "proj-taskforge",
        category: "Projects",
        title: "TaskForge",
        sub: "Event-Driven Workflow Automation Engine",
        action: () => router.push("/projects/taskforge"),
      },
      {
        id: "ctrl-lighting",
        category: "Studio Controls",
